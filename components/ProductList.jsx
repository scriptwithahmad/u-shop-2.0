            ...
            {AllProductsData.map((v, i) => (
              ...
              >
                <div className="absolute top-4 right-3 flex flex-col gap-2 group-hover:translate-x-0 translate-x-12 transition-all duration-500 z-30">
                  <i onClick={() => addToCart(v)} className="fa-solid fa-cart-plus text-slate-600 bg-gray-200 p-2 rounded cursor-pointer hover:bg-gray-300"></i>
                ...
                <div className="h-[270px] px-4 pt-4 bg-transparent w-full overflow-hidden rounded-md bg-gray-200">
                  <img
                    src={v.avatar}
                    alt={v.name}
                    className="h-full w-full group-hover:scale-105 transition-all duration-300 rounded-lg object-cover object-center"
                  />
                </div>
                <div className="px-4 py-4">
                  <h3 className="text-lg font-medium text-slate-700 line-clamp-1">
