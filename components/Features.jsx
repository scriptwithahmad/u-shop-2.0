...
const Features = () => {
  ...
  return (
    <>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-[1200px] m-auto my-4 lg:my-16">
        ...
        <div class="col-span-1 md:col-span-2 row-span-2 relative bg-gray-200 rounded-lg shadow-xl">
          <img
            src="/fp5.png"
            alt="image here"
          ...
          <div className="p-4 flex justify-end h-full flex-col z-50">
            <button className="bg-orange-400 text-white px-4 py-1 text-sm rounded-sm cursor-text w-fit z-50">
              UP TO 30% OFF
            </button>
            ...
            <Link
              href={"/categories"}
              className="mt-2 text-gray-500 text-sm z-50 border-b border-b-gray-400 pb-1 w-fit hover:text-orange-500 hover:border-b-orange-400 transition-all duration-300 cursor-pointer"
            >
              Shop Now
            </Link>

            <div className=" mt-8 z-50">
              <h1 className="mb-4 text-xl font-semibold text-orange-400">
                Count Down Starts
              </h1>
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="grid place-items-center rounded-xl py-2 bg-gray-100 shadow-lg">
                  <h2 id="Min" className=" text-xl font-semibold text-gray-500">
                    {minutesRemaining}
                  </h2>
                  <span className="text-gray-700 text-xs">Min</span>
                </div>
                <div className="grid place-items-center rounded-xl py-2 bg-gray-100 shadow-lg">
                  <h2 id="Sec" className=" text-xl font-semibold text-gray-500">
                    {secondsRemaining}
                  </h2>
                  <span className="text-gray-700 text-xs">Sec</span>
                </div>
                {/* <div className="grid place-items-center rounded-xl py-2 bg-orange-500 shadow-lg">
                  <h2 className=" text-xl font-semibold text-gray-50">Shop</h2>
                  <span className="text-gray-200 text-xs">Now</span>
                </div> */}
              </div>
            </div>
          </div>
        </div>
        <div class="col-span-2 md:col-span-2 row-span-1 bg-gray-200 rounded-lg shadow-xl">
          <div className=" flex items-center gap-8 justify-center">
            ...
            <div>
              ...
              <Link
                href="/categories"
                className=" bg-orange-400 px-3 py-1 rounded-md text-white hover:bg-orange-500 transition-all"
              >
                Shop Now
              </Link>
            </div>
